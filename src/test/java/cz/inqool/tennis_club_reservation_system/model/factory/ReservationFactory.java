...
public class ReservationFactory {
    ...
    private static final UserDto defaultUserDto = createUserDto(1L, "billy");
    ...
    public static Reservation createReservation(Long id, GameType gameType, LocalDateTime fromDate, LocalDateTime toDate) {
        var reservation = createReservation(id, gameType);
